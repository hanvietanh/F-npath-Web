...
import { FEATURED_EXPERTS, RECOMMENDED_EXPERTS, TOP_PL_EXPERTS, ExpertCardData } from './constants';

const ExpertCard: React.FC<{ expert: ExpertCardData }> = ({ expert }) => (
            ...
            <div className="flex gap-2.5">
                ...
                <div>
                    <div className="flex items-center gap-1">
                        <h3 className="font-bold text-sm text-gray-100 hover:text-[#2962ff] cursor-pointer">{expert.name}</h3>
